...
export class UserService {
  ...
  updateUploadedStandalone(emailId,title){
        return this.http.put("http://13.235.52.81:8083/user-service/producer/standalone/"+emailId+"/"+title,{
  ...
  updateUploadedEpisodic(emailId,title){
       return this.http.put("http://13.235.52.81:8083/user-service/producer/episodic/"+emailId+"/"+title,{
